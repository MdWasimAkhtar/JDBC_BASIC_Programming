...
class Prepared_stmt_Update
{
	public static void main(String[] aa)
	{
        ...
        public static void preCompiled_stmt(){
        	...
        	String Query = "update Student set grade = ? where rollno = ? ";
        	...
        	PreparedStatement pst = con.prepareStatement(Query);
        	 ...
        	 )
        	 {
        	 	...
        	 	System.out.println("data base product  version : "+dbmd.getDatabaseProductVersion());
